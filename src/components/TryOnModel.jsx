...
import { X, Upload, Share2, Download, Sparkles } from "lucide-react";
...
const TryOnModal = ({ isOpen, onClose, selectedProduct }) => {
                  ...
                  <div className="relative">
                    ...
                    {!isProcessing && (
                      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-4">
                        ...
                        <button className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-2 rounded-full flex items-center space-x-2 hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 shadow-lg">
